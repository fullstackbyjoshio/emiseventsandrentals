...
const sections = {
  statement1: {
    ...
    image: '/statement_tablescape.webp',
    zIndex: 20,
  },
  split1: {
    label: 'ABOUT',
    ...
    ctaLink: '/inventory',
    image: '/inventory_tableware.webp',
  ...
  split6: {
    ...
    ctaLink: '/contact',
    image: '/experience_flower_wall.webp',
    imagePosition: 'right' as const,
    zIndex: 90,
  },
  split7: {
    ...
    cta: 'Read our story',
    ctaLink: '/about',
    image: '/community_table_detail.webp',
    imagePosition: 'left' as const,
    zIndex: 100,
  },
  split8: {
