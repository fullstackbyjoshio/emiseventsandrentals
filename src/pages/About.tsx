...
export default function About() {
  ...
  return (
    <>
      <Helmet>
        <title>About Us | Emis Events and Rentals - Ogun State, Nigeria</title>
        <meta name="description" content="Learn about Emis Events and Rentals. We're a dedicated team providing premium event rentals and styling services in Ilisan Remo, Ogun State, Nigeria." />
        <meta name="keywords" content="about Emis Events, event rental company Ogun State, wedding styling Nigeria, event planners Ilisan Remo" />
        <link rel="canonical" href="https://emiseventsandrentals.com/about" />
        
        {/* Open Graph */}
        <meta property="og:title" content="About Us | Emis Events and Rentals - Ogun State, Nigeria" />
        <meta property="og:description" content="Learn about Emis Events and Rentals. Premium event rentals and styling in Ilisan Remo, Ogun State, Nigeria." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://emiseventsandrentals.com/about" />
        <meta property="og:image" content="https://emiseventsandrentals.com/og-image.jpg" />
        
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About Us | Emis Events and Rentals - Ogun State, Nigeria" />
        <meta name="twitter:description" content="Learn about Emis Events and Rentals. Premium event rentals and styling in Ilisan Remo, Ogun State, Nigeria." />
